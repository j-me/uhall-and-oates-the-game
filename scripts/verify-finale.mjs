...
assert.equal(action.performance.audio, 'assets/audio/music/youre-doing-it.mp3');
assert(existsSync(action.performance.audio), 'Final performance must use the distributable original recording');
