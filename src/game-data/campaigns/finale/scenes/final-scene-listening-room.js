...
export const finalListeningRoom = {
  ...
  hotspots: [
    ...
    { id: 'baltos-final', label: 'Baltos, audio forensicist', bounds: { left: 68, top: 39, width: 15, height: 23 }, responses: { look: 'Baltos has labeled every cable “probably important.”', talk: 'BALTOS: Mono is decisive. Stereo is suspicious.\nJOHN: Which one did you break?\nBALTOS: I prefer “liberated into components.”' } },
