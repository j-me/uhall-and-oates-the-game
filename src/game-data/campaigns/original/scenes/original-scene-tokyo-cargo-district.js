import { chapterFiveDialogue as dialogue } from '../dialogue/original-dialogue-chapter-05.js';
...
export const tokyoCargoDistrict = {
  ...
  hotspots: [
    ...
    { id: 'huey', label: 'Huey Lewis', bounds: { left: 70, top: 23, width: 15, height: 64 }, responses: { talk: dialogue.huey.talk, look: dialogue.huey.look }, useWith: { privateEyesManifest: { clearSelection: true, setFlags: ['hueyReadTheNews'], message: dialogue.huey.news } } },
  ],
};
