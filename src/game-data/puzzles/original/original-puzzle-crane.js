  ...
  const overlay = createPuzzleOverlay(root, {
    ...
    html: `
      ...
      <div class="crane-cabinet">
        <img class="crane-cabinet-art" src="assets/art/campaigns/original/chapters/chapter-01/crane-cabinet-interior-v2.png" alt="">
        <div class="crane-rail"><span class="crane-carriage"><i></i></span></div>
        <img class="crane-fries" src="assets/art/campaigns/original/chapters/chapter-01/crane-fries-v1.png" alt="carton of French fries">
      </div>
